...
MAINTAINER Urs Kläusler <urs.klaeusler@gmail.com>
...
RUN apk add --no-cache nginx php81-fpm php81-gd php81-json php81-dom php81-xml php81-zip supervisor unzip curl 
